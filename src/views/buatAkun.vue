      ...
      <v-stepper elevation="0" v-model="el">
        <v-stepper-items>
          <v-stepper-content step="1">
            <v-card elevation="0">
              ...
              <v-card-subtitle class="d-flex justify-center"
                ><span
                  >Disarankan menggunakan nama lengkap asli, digunakan untuk checkout
                  dll.</span
                ></v-card-subtitle
              >
          ...
          <v-stepper-content step="2">
            <v-card elevation="0">
              <v-card-title class="pt-0 text-h5 d-flex justify-center">
                <span>Masukkan Email</span></v-card-title
              >
              <v-card-subtitle class="d-flex justify-center"
                ><span>Masukkan email anda yang valid</span></v-card-subtitle
              >
              <v-card-text class="px-2">
                <v-text-field
                  v-model="email"
          ...
          <v-stepper-content step="3">
            <v-card elevation="0">
              <v-card-title class="pt-0 text-h5 d-flex justify-center">
                <span>Buat Password</span></v-card-title
              >
              <v-card-subtitle class="d-flex justify-center"
                ><span>Buat password minimal 8 huruf</span></v-card-subtitle
              >
              <v-card-text class="px-2">
                <v-text-field
                  v-model="password"
          ...
          <v-stepper-content step="4">
            <v-card elevation="0">
              <v-card-title class="pt-0 text-h5 d-flex justify-center">
                <span>Pilih Foto Profil</span></v-card-title
              >
              <v-card-subtitle class="d-flex justify-center"
                ><span>usahakan menggunakan foto asli anda</span></v-card-subtitle
              >
              ...
              <v-card-text class="d-flex justify-center"
                ><v-btn text color="primary" @click="pilihGambar"
                  >pilih gambar</v-btn
                ></v-card-text
              >
              <v-card-actions
                ><v-btn @click="buatAkun" :loading="loading" block large color="primary"
                  >Buat Akun</v-btn
                ></v-card-actions
              >
            </v-card>
